...
using (SqliteConnection connection = new SqliteConnection(connectionString))
{
    ...
    // Insertar datos
    string insertQuery = "INSERT INTO productos (Descripcion, Precio) VALUES ('Logitech G205', 14.50)";
    ...
    // Leer datos
            ...
            using (SqliteDataReader reader = selectCmd.ExecuteReader())
            {
                ...
                while (reader.Read())
                {
                    Console.WriteLine($"ID: {reader["idProductos"]}, Nombre: {reader["Descripcion"]}, Precio: {reader["Precio"]}");
                }
            }
